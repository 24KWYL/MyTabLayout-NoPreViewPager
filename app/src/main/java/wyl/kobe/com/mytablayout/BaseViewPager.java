...
// o(t) = _o(t - 1) + 1
    ...
    //    private OnPageChangeListener mTitleChangeListener;
...
// This space for rent
    ...
    private void setScrollState(int newState) {
        ...
        for (int i = 0; i < pageChangeListeners.size(); i++) {
            OnPageChangeListener mTitleChangeListener = pageChangeListeners.get(i);
            if (mTitleChangeListener != null) {
                mTitleChangeListener.onPageScrollStateChanged(newState);
            }
...
// until the scroll ends.
        ...
        if (smoothScroll) {
            ...
            for (int i = 0; i < pageChangeListeners.size(); i++) {
                OnPageChangeListener mTitleChangeListener = pageChangeListeners.get(i);
                if (dispatchSelected && mTitleChangeListener != null) {
                    mTitleChangeListener.onPageSelected(item);
                }
            }
            ...
            if (mScroller.computeScrollOffset()) {
                ...
                for (int i = 0; i < pageChangeListeners.size(); i++) {
                    ...
                    if (mTitleChangeListener != null) {
                        ...
                        mTitleChangeListener.onPageScrolled(position, offset, offsetPixels);
                    }
                }
...
// Don't lose the rounded component
                    ...
                    for (int i = 0; i < pageChangeListeners.size(); i++) {
                        ...
                        if (mTitleChangeListener != null) {
                            ...
                            mTitleChangeListener.onPageScrolled(position, positionOffset,
